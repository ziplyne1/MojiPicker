...
## Installation
MojiPicker is on the [Swift Package Index](https://swiftpackageindex.com/ziplyne1/MojiPicker). Install it using the [Swift Package Manager](https://docs.swift.org/swiftpm/documentation/packagemanagerdocs/).
